...
namespace Volt
{
    ...
    void COpenGLVertexArray::AddVertexBuffer(const SharedPtr<IVertexBuffer>& vertexBuffer)
    {
    ...
    void COpenGLVertexArray::SetIndexBuffer(const SharedPtr<IIndexBuffer>& indexBuffer)
    {
        glBindVertexArray(m_rendererID);
        indexBuffer->Bind();
